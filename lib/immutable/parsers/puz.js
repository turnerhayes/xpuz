...
var MutablePUZParser = require("../../parsers/puz");
var Utils = require("../utils");

var PUZParser = function (_MutablePUZParser) {
	_inherits(PUZParser, _MutablePUZParser);

	function PUZParser() {
		_classCallCheck(this, PUZParser);

		return _possibleConstructorReturn(this, (PUZParser.__proto__ || Object.getPrototypeOf(PUZParser)).apply(this, arguments));
	}
	...
	_createClass(PUZParser, [{
		...
		value: function parse() {
			...
			return (_get2 = _get(PUZParser.prototype.__proto__ || Object.getPrototypeOf(PUZParser.prototype), "parse", this)).call.apply(_get2, [this].concat(args)).then(Utils.toImmutable);
		}
	}, {
		key: "generate",
		value: function generate(puzzle) {
			return _get(PUZParser.prototype.__proto__ || Object.getPrototypeOf(PUZParser.prototype), "generate", this).call(this, Utils.toMutable(puzzle));
		}
	}]);
